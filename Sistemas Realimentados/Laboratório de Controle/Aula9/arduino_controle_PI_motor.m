% function [y,u,t] = arduino_controle_PI_motor(obj,Ref,Tempo, Kp,Ki)
...
a1=num2str(round(1000*Cd.Den{1}(2),0));
    ...
    a1=num2str(0);
    b2=num2str(0);
    b1=num2str(round(Kp*1000));
end


comando=sprintf('%s;%s;%s;%s;%s;%s;%s;','2','0',num2str(round(Tempo,0)),num2str(round(Ref,0)),b1,b2,a1);

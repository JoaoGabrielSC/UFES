% function [Y,t,Yr,tau] = arduino_coleta_motor(obj,U0,Tempo)
% Coleta de dados do motor CC
% Data: 22/11/2022
% Mac
function [Y,t,Yr,tau] = arduino_coleta_motor(obj,U0,Tempo)
Ts=20;
...
for k=1:length(U0)
    comando=sprintf('%s;%s;','1','0',num2str(round(Tempo,0)),num2str(round(U0(k),0)));
...
if nargout==0
    ...
    line([0 max(t)],[U0 U0],'Color','r','LineWidth',3);
    xlabel('Tempo(s)');
    ylabel('Resposta');
end
